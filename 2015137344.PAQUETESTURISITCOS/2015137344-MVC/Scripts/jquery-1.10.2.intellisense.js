...
intellisense.annotate(jQuery.fn, {
  ...
  '_UnityOfWorklclick': function() {
    /// <signature>
    ///   <summary>Bind an event handler to the "_UnityOfWorklclick" JavaScript event, or trigger that event on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
